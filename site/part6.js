...
function pageSystem(root){
  const gates=[
   ...
   [6,'Lọc ngành','Danh mục có bị dồn quá nhiều vào một ngành không?','Trần 30% NAV cho một nhóm ngành ICB khi MỞ lệnh mới. Lệnh nhồi chỉ xét trần mã 50% + tiền mặt nên ngành có thể vượt 30% (lịch sử: 2 lần — TCM 11/2020 lên 48,5%, GEE 10/2025 lên 39,9%).','B'],
   ...
   [9,'Pyramid','Có nên gia tăng vị thế không?','Phiên 4–7 sau điểm mua, đang lãi ≥ 10%, giá ≥ 99,9% đỉnh 10 phiên, chỉ 1 lần, chỉ khi đèn Xanh. Thêm 50% vị thế gốc nếu sau khi nhồi mã đó vẫn ≤ trần mỗi mã (50% NAV) và đủ tiền mặt. <b>Trần ngành 30% chỉ áp cho lệnh mới, không áp cho lệnh nhồi</b> — đó là luật đang chạy (đo lại 26/09 trên TOP110 + S1: bắt lệnh nhồi tôn trọng cả trần ngành thì +957,2% còn +859,0%, DD không đổi 11,74%, do chặn đúng 2 lệnh nhồi trong 7,7 năm; anh Sơn giữ luật cũ). Mỗi lệnh vào/nhồi đều ghi tỷ trọng mã / ngành / tổng trên NAV sau khi khớp.','B'],
  ];
